...
func (MySqlUserRepository) CreateNewUser(userRequest models.UserRequest) error {
...
func (MySqlUserRepository) CheckIfUserAlreadyExist(request models.UserRequest) (bool, error) {
...
func (MySqlUserRepository) CheckPassword(dto models.UserRequest) (uint, error) {
